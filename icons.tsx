...
// New Minimalist Icons for Redesign
export const NewHomeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955a.75.75 0 011.06 0l8.955 8.955M3.75 10.5V21a.75.75 0 00.75.75H9v-7.5H15v7.5h4.5a.75.75 0 00.75-.75V10.5M20.25 12H3.75" />
  </svg>
);

export const NewExploreIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 100-18 9 9 0 000 18zM12 3v2.25m0 13.5V21m-8.25-8.25H3m15.75 0H18m-4.5-4.5L8.25 8.25m7.5 7.5L8.25 15.75" /> 
  </svg>
);

export const NewListIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => ( // Simplified bookmark style
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M17.593 3.322c.1.121.1.287.001.408L12 10.409 6.407 3.73c-.1-.12-.1-.287 0-.407.1-.122.268-.122.368 0l5.226 6.098L17.225 3.322c.1-.121.268-.121.368 0zM6 21V4.5" />
  </svg>
);

export const NewUserIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
  </svg>
);

// End of New Minimalist Icons

// ADDING A NEW FILTER ICON
export const FilterIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" {...props}>
    <path fillRule="evenodd" d="M2.628 1.601C5.028 1.206 7.49 1 10 1s4.973.206 7.372.601a.75.75 0 01.628.74v2.288a2.25 2.25 0 01-.659 1.59l-4.682 4.683a2.25 2.25 0 00-.659 1.59v3.032c0 .872-.673 1.59-1.5 1.59h-.798c-.036 0-.072.005-.107.014L8 18.25a.75.75 0 01-.928-.642V13.97a2.25 2.25 0 00-.659-1.59L1.724 7.702A2.25 2.25 0 011 6.112V3.824a.75.75 0 01.628-.74V1.601zM3.5 2.404v1.42l.001.002a.75.75 0 00.22.53l4.682 4.683a.75.75 0 01.22.53V13.5a.75.75 0 00.75.75h.008a.75.75 0 00.75-.75v-4.03a.75.75 0 01.22-.53l4.682-4.683a.75.75 0 00.22-.53l.001-.002V2.404a25.048 25.048 0 00-6.5 0c-.663 0-1.32.016-1.973.048a25.048 25.048 0 00-1.973-.048z" clipRule="evenodd" />
  </svg>
);

// END OF NEW FILTER ICON
